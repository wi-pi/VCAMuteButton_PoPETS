...
def processing(mname):
    ...
    with open(mname+'_3_final.pkl','wb') as f:
        pickle.dump(data, f)
...
# Here in our used dataset, we showed the number of samples in each class here.
# ova_train_10cm
# len data 1646
# 144
# 151
